...
export default function Home() {
  ...
  return (
    ...
    // </div>
    <>
      <nav className="bg-[#a9918a] text-[#F4EEED] px-4 py-2 flex justify-between items-center">
        <h1 className="text-lg font-semibold">Just Do It!</h1>
        <button
          onClick={() => {
            navigate("/", { replace: true });
            localStorage.clear();
          }}
          className="bg-[#999B84] hover:bg-[#999b84ca] text-[#F4EEED] px-3 py-1 rounded-md"
        >
          Logout
        </button>
      </nav>
      <div className=" flex justify-center  min-h-screen bg-[#EFD9D1]">
        {isClicked === 0 ? (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        />
                        <p className="text-[#F4EEED] font-bold">
                          {todo.content}
                        </p>
                      </div>
                      {todo.endDate && (
